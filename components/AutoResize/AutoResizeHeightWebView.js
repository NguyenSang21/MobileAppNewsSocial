...
import { StyleSheet, View, WebView , Text, ActivityIndicator } from 'react-native';
...
class AutoResizeHeightWebView extends React.Component {
    ...
    resetHeight(){
        ...
        this.setState({
            ...
            if(this.props.onAutoHeight) this.props.onAutoHeight();
        });
        this.gotoShow();
    }
    ...
    render(){
        ...
        return (
            <View style={{backgroundColor:"#FFFFFF"}}>
                <View style={{height:this.state.height,/*opacity:this._animatedValue*/}}>
                    <WebView
                        {...otherprops}
                ...
                { this.state.height == 0 ?
                    <View style={styles.loader}>
                        <ActivityIndicator size='large' color='#43a047' alignSelf='center'/>
                    </View>
                : null }
            </View>
        );
